...
ChromeOS is highly secure and perfectly suited for your job role because it can __only__ run the Chrome web browser. That means anything you do must happen on a web site. Luckily, everything you need to do will be interacting with different web services, so this 
